...
const FirstLook = ({ image, description, onSeeMore, onSave, onShare, isSaved = false }) => {
  ...
  return (
    <div className="h-[100dvh] flex flex-col bg-background overflow-hidden relative">
      ...
      <div className="absolute top-[160px] right-4 flex gap-2 z-10">
        <button
          onClick={handleSave}
      ...
      {/* Saved feedback */}
      {showSaved && (
        <div className="absolute top-[208px] right-4 px-3 py-1.5 rounded-full bg-brand text-white text-sm font-medium animate-fade-in z-10">
          Saved!
        </div>
      )}
